...
import {RegistroObservacoesResolver, RegistroResolver, RegistrosResolver} from '@app/pages/projetos/projeto/resolvers/registros.resolver';
import {AprovadorModule} from '@app/pages/projetos/projeto/refp/aprovador/aprovador.module';
import {DetalhesModule} from '@app/pages/projetos/projeto/refp/detalhes/detalhes.module';
import {EditarModule} from '@app/pages/projetos/projeto/refp/editar/editar.module';
