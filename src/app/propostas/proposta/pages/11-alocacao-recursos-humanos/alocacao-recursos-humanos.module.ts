...
import {EtapasService, RecursosHumanosService} from '@app/propostas/proposta/services/proposta-service-base.service';
import {EmpresasResolver} from '@app/propostas/proposta/resolvers';
import {EtapasResolver} from '@app/propostas/proposta/resolvers';
import {RecursosHumanosResolver} from '@app/propostas/proposta/resolvers';
