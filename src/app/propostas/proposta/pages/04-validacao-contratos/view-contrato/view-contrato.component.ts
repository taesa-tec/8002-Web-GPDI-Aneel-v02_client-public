...
import {HistoricoComponent} from '@app/propostas/proposta/pages/04-validacao-contratos/historico/historico.component';
import {Contrato} from '@app/propostas/proposta/pages/04-validacao-contratos/shared';
