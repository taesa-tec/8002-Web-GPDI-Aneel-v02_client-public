...
import {PropostaComponent} from '@app/propostas/proposta/proposta.component';
import {
  AlocarRecursoMaterialFormComponent
} from '@app/propostas/proposta/pages/13-alocacao-recursos-materiais/alocar-recurso-material-form/alocar-recurso-material-form.component';
import {
  AlocarRecursoHumanoFormComponent
} from '@app/propostas/proposta/pages/11-alocacao-recursos-humanos/alocar-recurso-humano-form/alocar-recurso-humano-form.component';
