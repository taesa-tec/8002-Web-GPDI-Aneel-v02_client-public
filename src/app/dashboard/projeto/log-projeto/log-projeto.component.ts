...
export class LogProjetoComponent implements OnInit {
  ...
  constructor(protected app: AppService, protected route: ActivatedRoute, protected usersService: UsersService) {
  }
  ...
  async loadData() {
    ...
    this.usuarios = await this.usersService.all().toPromise();
