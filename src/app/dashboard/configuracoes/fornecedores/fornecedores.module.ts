...
import {FornecedoresRoutingModule} from '@app/dashboard/configuracoes/fornecedores/fornecedores-routing.module';
import {ListResolver} from '@app/resolvers/list.resolver';
import {ItemResolver} from '@app/resolvers/item.resolver';
import {FornecedorFormComponent} from '@app/dashboard/configuracoes/fornecedores/fornecedor-form/fornecedor-form.component';
