...
import {GerenciarUsuariosRoutingModule} from '@app/gerenciar-usuarios/gerenciar-usuarios-routing.module';
...
import {UserFormComponent} from '@app/gerenciar-usuarios/user-form/user-form.component';
import {EmpresasResolver} from '@app/resolvers/empresas.resolver';
import {UserResolver} from '@app/gerenciar-usuarios/users.resolver';
