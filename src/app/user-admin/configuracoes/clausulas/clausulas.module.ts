...
import {ClausulasRoutingModule} from '@app/user-admin/configuracoes/clausulas/clausulas-routing.module';
import {ClausulasResolver} from '@app/user-admin/configuracoes/clausulas/clausulas.resolver';
