...
import {FornecedoresComponent} from '@app/user-admin/configuracoes/fornecedores/fornecedores.component';
import {FornecedoresRoutingModule} from '@app/user-admin/configuracoes/fornecedores/fornecedores-routing.module';
